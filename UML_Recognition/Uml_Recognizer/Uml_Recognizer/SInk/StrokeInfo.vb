...
Public Class StrokeInfo
    ...
    Protected _distances As Distances
    Protected _stroke As Stroke
    Protected _vectors As String
    Protected _strokeStatistics As New StrokeStatistics
    Protected _penVelocity() As Double
    ...
    Protected Function GetStrokeStatistics() As StrokeStatistics
        ...
        With strokeStats
            ...
            .StopPoints = CalculateStopPoints(Stroke)
        End With
